...
export default function Signup() {
  return (
    <main>
      <Link to={`/`} className="text-primary-600 flex gap-x-2 items-center font-inter font-bold pt-[79px] pl-[113px]">
  ...
  <defs>
    <clipPath id="clip0_577_957">
      ...
      <section className="mt-10 flex flex-col items-center font-inter gap-y-8 md:w-[475px] w-full mx-auto">
  ...
  <path d="M0.5 0.5L200.5 0.500017" stroke="#B9C2C8" strokeLinecap="round"/>
        ...
        <form action="" className="flex flex-col font-workSans w-full gap-y-8">
          ...
          <span className="text-sm font-medium">Email</span>
              <input type="email" placeholder="Enter your email address" name="email" id="email"
                className="w-[475px] h-[51px] p-4 rounded-xl border border-[#B6B3C6] justify-start items-center gap-2 inline-flex bg-[none] outline-none focus:outline-none"
          />
        </label>

        <label htmlFor="password" className="font-workSans flex flex-col gap-y-3">
          <span className="text-sm font-medium">Password</span>
          <input type="password" placeholder="Enter your password" name="password" id="password" className="w-[475px] h-[51px] p-4 rounded-xl border border-[#B6B3C6] justify-start items-center gap-2 inline-flex bg-[none] outline-none focus:outline-none"/>
        </label>
          </div>
          
        <button className="font-workSans text-center bg-primary-500 text-[#F9F9FF] text-lg font-medium rounded-lg p-4 mb-[100px]">Sign Up</button>
        </form>
